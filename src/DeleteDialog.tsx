...
export function DeleteDialog({
  ...
  const dispatch = useDispatch()
   const deletingCardID = useSelector((state: { deletingCardID: string }) => state.deletingCardID)
   const cardsOrder = useSelector((state: { cardsOrder: string[] }) => state.cardsOrder)
